<div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
    ...
    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
        ...
        <ul class="py-2 font-medium" role="none">
            @if($_profile->user->hasRole('super-admin'))
            <li>

              <a href="{{ url('idoteca/admin/profiles') }}"
            ...
            <li>
                ...
                {{--  
                <x-filament::button class="text-gray-700" icon="fas-sign-out-alt" color="danger" tag="a"
                    href="{{ route('logout') }}">
                    Log Out
                </x-filament::button>
                --}}
    ...
    {{--  
    <button data-collapse-toggle="navbar-profile" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-profile" aria-expanded="false">
