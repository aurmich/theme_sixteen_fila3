...
<x-layouts.marketing>
	...
	<div class="relative flex flex-col w-full px-6 py-10 mx-auto lg:max-w-6xl sm:max-w-xl md:max-w-full sm:pb-16">
		...
		<p class="w-full mt-2 text-base font-medium text-neutral-400 dark:text-slate-400 md:mt-2">Find out all the latest news around A.I. We stay up-to-date with the latest technologies and AI news so you dont have to.</p>
			...
			<article class="flex space-x-8">
				...
				<div class="w-7/12 mt-2">
					<div class="mb-1 text-sm">
						<svg class="dark:text-gray-400 -mt-0.5 h-3.5 inline-block w-3.5" data-icon="tabler:clock" height="1em" viewBox="0 0 24 24" width="1em">
						...
						<time class="inline-block dark:text-gray-400">{{ date('F j, Y', $post->updated_at->timestamp) }}</time>
						<span class="mx-2">·</span>
						<a class="font-medium underline capitalize hover:underline dark:text-gray-400" href="/category/documentation">{{ $post->user?->name ?? 'John Doe' }}</a>
					</div>
					<h2 class="mb-2 text-xl font-medium leading-tight underline dark:text-slate-300 font-heading sm:text-2xl">
						<a class="transition duration-200 ease-in dark:hover:text-blue-700 hover:text-primary" href="{{ $this->route_prefix }}/{{ $post->slug }}">{{ $post->title }}</a>
					</h2>
					...
					<ul class="mt-5 text-sm">
						<li class="inline-block px-3 pt-1 pb-1.5 mb-2 mr-2 text-xs font-medium text-gray-500 hover:text-gray-700 lowercase bg-gray-200 rounded-full dark:bg-slate-700">
							<a class="dark:hover:text-gray-200 dark:text-slate-300 hover:text-primary" href="/tag/tag1">tag1</a>
						</li>
						<li class="inline-block px-3 pt-1 pb-1.5 mb-2 mr-2 text-xs font-medium text-gray-500 hover:text-gray-700 lowercase bg-gray-200 rounded-full dark:bg-slate-700">
							<a class="dark:hover:text-gray-200 dark:text-slate-300 hover:text-primary" href="/tag/tag1">tag2</a>
						</li>
						<li class="inline-block px-3 pt-1 pb-1.5 mb-2 mr-2 text-xs font-medium text-gray-500 hover:text-gray-700 lowercase bg-gray-200 rounded-full dark:bg-slate-700">
							<a class="dark:hover:text-gray-200 dark:text-slate-300 hover:text-primary" href="/tag/tag1">tag3</a>
						</li>
					</ul>
				</div>
			</article>
