...
<?php $component->withAttributes([]); ?>
      ...
      <div class="container" id="main-container">
        <div class="row justify-content-center mb-md-40 mb-lg-80">
          <div class="col-12 col-lg-10">
            ...
            </div>        <div class="cmp-heading p-0">
              <h1 class="title-xxxlarge">Elenco segnalazioni</h1>

              <p class="subtitle-small">Negli ultimi 12 mesi sono state risolte 73 segnalazioni.</p>
                      ...
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="water" name="category" value="acqua,allagamenti,fogne">
                            <label for="water" class="subtitle-small_semi-bold mb-0 category-list__list">Acqua, allagamenti, problemi fognari (21)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="enviroment" name="category" value="inquinamneto">
                            <label for="enviroment" class="subtitle-small_semi-bold mb-0 category-list__list">Ambiente, inquinamento, protezione ambientale (14)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="street-furniture" name="category" value="arredo-urbano">
                            <label for="street-furniture" class="subtitle-small_semi-bold mb-0 category-list__list">Arredo urbano (7)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="rodent-control" name="category" value="derattizazione">
                            <label for="rodent-control" class="subtitle-small_semi-bold mb-0 category-list__list">Disinfestazione, derattizazione, animali randagi (208)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="waste" name="category" value="igiene">
                            <label for="waste" class="subtitle-small_semi-bold mb-0 category-list__list">Igiene urbana, rifiuti, pulizia e decoro (321)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="maintenance" name="category" value="manutenzione">
                            <label for="maintenance" class="subtitle-small_semi-bold mb-0 category-list__list">Manutenzione immobili, edifici pubblici, scuole, barriere architettoniche, cimiteri (302)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="public-order" name="category" value="ordine-pubblico">
                            <label for="public-order" class="subtitle-small_semi-bold mb-0 category-list__list">Ordine pubblico, disturbo della quiete (302)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="green" name="category" value="parchi">
                            <label for="green" class="subtitle-small_semi-bold mb-0 category-list__list">Parchi e verde pubblico (302)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="service" name="category" value="servizi">
                            <label for="service" class="subtitle-small_semi-bold mb-0 category-list__list">Servizi del comune (302)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="security" name="category" value="sicurezza">
                            <label for="security" class="subtitle-small_semi-bold mb-0 category-list__list">Sicurezza, degrado urbano e sociale (302)</label>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="form-check">
                          <div class="checkbox-body border-light py-1">
                            <input type="checkbox" id="road" name="category" value="strade">
                            <label for="road" class="subtitle-small_semi-bold mb-0 category-list__list">Strade, marciapiedi, segnaletica e viabilità (302)</label>
                          </div>
                        </div>
                      </li>
                  </ul>
            ...
            <div class="tab-content">
              <div class="tab-pane fade show active" id="data-ex-disservizio1" role="tabpanel">
                <div class="row">
                  <div class="col-12">
                    <div class="map-box">
                      <img src="../assets/images/map-placeholder.svg" alt="Mappa" class="w-100">
                      <button type="button" class="pin" data-bs-toggle="modal" data-bs-target="#modal-disservizio">
                        <img src="../assets/images/map-pin.svg" alt="Pin di geolocalizzazione" title="Pin di geolocalizzazione">
                      </button>
                    </div>              </div>
    ...
    <div class="cmp-text-button mt-0">
       ...
       <div class="text-wrapper">
         <p class="subtitle-small mb-3 mt-3">Se vuoi aggiungere una segnalazione, puoi farlo dopo esserti autenticato con le tue
                    credenziali SPID o CIE.</p>
       </div>
                        ...
                        <div class="cmp-info-button-card">
                          <div class="card p-3 p-lg-4">
                            <div class="card-body p-0">
                              ...
                              <h3 class="medium-title mb-0">Buca in via Solferino</h3>



                              <p class="card-info">Tipologia di segnalazione <br>
                                      <span>Verde pubblico e arredo urbano</span></p>
                              ...
                              <div class="accordion-item">
                                <div class="accordion-header">
                                  <button class="collapsed accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
                                ...
                                <div id="collapse1" class="accordion-collapse collapse pb-0" role="region">
                                      ...
                                      <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                          ...
                                          <div class="single-line-info border-light">
                                            ...
                                            <div class="border-light">
                                              <p class="data-text">
                                                Sulla strada c’è una buca piuttosto profonda che andrebbe  sistemata con urgenza
                                              </p>
                        ...
                        <div class="cmp-info-button-card">
                          <div class="card p-3 p-lg-4">
                            <div class="card-body p-0">
                              ...
                              <h3 class="medium-title mb-0">Titolo segnalazione 2</h3>



                              <p class="card-info">Tipologia segnalazione</p>
                              ...
                              <div class="accordion-item">
                                <div class="accordion-header">
                                  <button class="collapsed accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                    <span class="d-flex align-items-center">
                                    Mostra tutto
                                      <svg class="icon icon-primary icon-sm">
                                        <use href="../assets/bootstrap-italia/dist/svg/sprites.svg#it-expand"></use>
                        ...
                        <div class="cmp-info-button-card">
                          <div class="card p-3 p-lg-4">
                            <div class="card-body p-0">
                              ...
                              <h3 class="medium-title mb-0">Titolo segnalazione 3</h3>
                              ...
                              <div class="accordion-item">
                                <div class="accordion-header">
                                  <button class="collapsed accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                    <span class="d-flex align-items-center">
                                    Mostra tutto
                                      <svg class="icon icon-primary icon-sm">
                                        <use href="../assets/bootstrap-italia/dist/svg/sprites.svg#it-expand"></use>
...
<?php endif; ?><?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Themes/Sixteen/resources/views/pages/prova01.blade.php ENDPATH**/ ?>