        ...
        <div class="grid max-w-2xl grid-cols-1 gap-2 mx-auto mt-4 bg-opacity-25 lg:pt-0 md:grid-cols-2 lg:gap-4 lg:gap-y-1">
            <div>
                <a href="https://laravel.com/docs" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-900/80 dark:hover:bg-gray-900 dark:border-gray-500/20 group gap-x-2.5 hover:bg-white">
                    <span class="flex items-center justify-center flex-none w-8 h-8">
                        <svg class="w-7 h-7 text-[#FF2D20] fill-current" viewBox="0 0 50 52" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                <a href="https://livewire.laravel.com/docs" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-900/80 dark:hover:bg-gray-900 dark:border-gray-500/20 group gap-x-2.5 hover:bg-white">
                    <span class="flex items-center justify-center flex-none w-8 h-8">
                        <svg class="w-7 h-7" viewBox="0 0 39 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M36.72 29.234c-.717 1.084-1.262 2.42-2.72 2.42-2.455 0-2.588-3.784-5.044-3.784-2.456 0-2.323 3.785-4.777 3.785-2.455 0-2.588-3.785-5.043-3.785-2.456 0-2.324 3.785-4.778 3.785-2.455 0-2.587-3.785-5.043-3.785s-2.323 3.785-4.778 3.785c-.771 0-1.313-.374-1.77-.887C1.01 27.712 0 24.13 0 20.3 0 9.09 8.66 0 19.345 0c10.683 0 19.344 9.089 19.344 20.3 0 3.206-.708 6.238-1.969 8.934Z" fill="#FB70A9" />
                            <mask id="a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="6" y="23" width="26" height="21">
                                <path d="M11.62 27.23v8.408a2.732 2.732 0 0 1-5.465 0v-10.15c.51-.937 1.093-1.747 2.143-1.747 1.71 0 2.307 2.148 3.321 3.489Zm10.32.438v13.296a3.036 3.036 0 0 1-6.07 0V25.915c.57-1.102 1.16-2.174 2.368-2.174 1.912 0 2.433 2.687 3.703 3.927Zm9.715-.244v9.653a2.732 2.732 0 1 1-5.465 0V25.212c.476-.814 1.043-1.471 1.988-1.471 1.795 0 2.364 2.367 3.477 3.683Z" fill="white" />
                            </mask>
                            <g mask="url(#a-folio)">
                                <path d="M11.62 27.23v8.408a2.732 2.732 0 0 1-5.465 0v-10.15c.51-.937 1.093-1.747 2.143-1.747 1.71 0 2.307 2.148 3.321 3.489Zm10.32.438v13.296a3.036 3.036 0 0 1-6.07 0V25.915c.57-1.102 1.16-2.174 2.368-2.174 1.912 0 2.433 2.687 3.703 3.927Zm9.715-.244v9.653a2.732 2.732 0 1 1-5.465 0V25.212c.476-.814 1.043-1.471 1.988-1.471 1.795 0 2.364 2.367 3.477 3.683Z" fill="#4E56A6" />
                            </g>
                            <mask id="b" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="6" y="18" width="26" height="15">
                                <path d="M11.62 29.807c-.485-.594-1.059-1.034-1.889-1.034-1.97 0-2.332 2.483-3.576 3.602v-10.71a2.732 2.732 0 1 1 5.464 0v8.142Zm10.32.191c-.516-.687-1.12-1.225-2.037-1.225-2.192 0-2.393 3.073-4.034 3.923V27.96a3.036 3.036 0 0 1 6.072 0v2.038Zm9.715-.531c-.42-.414-.92-.694-1.58-.694-2.124 0-2.38 2.884-3.884 3.837v-9.613a2.732 2.732 0 1 1 5.464 0v6.47Z" fill="white" />
                            </mask>
                            <g mask="url(#b)">
                                <path d="M11.62 29.807c-.485-.594-1.059-1.034-1.889-1.034-1.97 0-2.332 2.483-3.576 3.602v-10.71a2.732 2.732 0 1 1 5.464 0v8.142Zm10.32.191c-.516-.687-1.12-1.225-2.037-1.225-2.192 0-2.393 3.073-4.034 3.923V27.96a3.036 3.036 0 0 1 6.072 0v2.038Zm9.715-.531c-.42-.414-.92-.694-1.58-.694-2.124 0-2.38 2.884-3.884 3.837v-9.613a2.732 2.732 0 1 1 5.464 0v6.47Z" fill="black" fill-opacity="0.298514" />
                            </g>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M36.72 29.234c-.717 1.084-1.262 2.42-2.72 2.42-2.455 0-2.588-3.784-5.044-3.784-2.456 0-2.323 3.785-4.777 3.785-2.455 0-2.588-3.785-5.043-3.785-2.456 0-2.324 3.785-4.778 3.785-2.455 0-2.587-3.785-5.043-3.785s-2.323 3.785-4.778 3.785c-.771 0-1.313-.374-1.77-.887C1.01 27.712 0 24.13 0 20.3 0 9.09 8.66 0 19.345 0c10.683 0 19.344 9.089 19.344 20.3 0 3.206-.708 6.238-1.969 8.934Z" fill="#FB70A9" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M32.534 31.25c5.07-7.541 5.2-15.906.393-25.095a20.248 20.248 0 0 1 5.762 14.188c0 3.194-.734 6.214-2.04 8.9-.744 1.08-1.31 2.412-2.821 2.412-.517 0-.935-.156-1.294-.405Z" fill="#E24CA6" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M18.307 25.364c6.728 0 9.56-3.902 9.56-9.445 0-5.542-4.28-10.643-9.56-10.643s-9.56 5.101-9.56 10.643c0 5.543 2.833 9.445 9.56 9.445Z" fill="white" />
                            <path d="M15.737 16.233c1.98 0 3.585-1.771 3.585-3.957 0-2.185-1.605-3.956-3.585-3.956s-3.585 1.771-3.585 3.956c0 2.186 1.605 3.957 3.585 3.957Z" fill="#030776" />
                            <path d="M15.14 13.19c.99 0 1.792-.818 1.792-1.827 0-1.008-.802-1.826-1.792-1.826s-1.793.818-1.793 1.826c0 1.009.803 1.827 1.793 1.827Z" fill="white" />
                        </svg>
                    </span>
                    <span class="flex flex-col justify-center h-full opacity-70 dark:opacity-80 group-hover:opacity-100 text-[0.65rem]">
            ...
            <div>
                <a href="https://alpinejs.dev/docs" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-900/80 dark:hover:bg-gray-900 dark:border-gray-500/20 group gap-x-2.5 hover:bg-white">
                    <span class="flex items-center justify-center flex-none w-8 h-8">
                        <svg class="w-7 h-7" viewBox="0 0 55 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="m42.753 0 12.112 12.06-12.112 12.058L30.641 12.06 42.753 0Z" fill="#77C1D2" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="m12.473 0 25.11 25H13.358L.36 12.06 12.473 0Z" fill="#2D3441" />
                        </svg>
                    </span>
                    <span class="flex flex-col justify-center h-full opacity-70 dark:opacity-80 group-hover:opacity-100 text-[0.65rem]">
            ...
            <div>
                <a href="https://github.com/laravel/folio" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-900/80 dark:hover:bg-gray-900 dark:border-gray-500/20 group gap-x-2.5 hover:bg-white">
                    <span class="flex items-center justify-center flex-none w-8 h-8">
                        <svg class="w-7 h-7" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M48 96c26.51 0 48-21.49 48-48S74.51 0 48 0 0 21.49 0 48s21.49 48 48 48Z" fill="#4F46E5" />
                            <mask id="a-folio" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="96" height="96">
                                <path d="M48 96c26.51 0 48-21.49 48-48S74.51 0 48 0 0 21.49 0 48s21.49 48 48 48Z" fill="white" />
                            </mask>
                            <g mask="url(#a-folio)">
                                <path d="M79 22H21v78h58V22Z" fill="#818CF8" />
                                <path d="M72.5 107h-58V29h38l20 20v58Z" fill="#F7F8FF" />
                                <path d="M72.5 49h-20V29l20 20Z" fill="#C7D2FF" />
                            </g>
                        </svg>
                    </span>
                    <span class="flex flex-col justify-center h-full opacity-70 dark:opacity-80 group-hover:opacity-100 text-[0.65rem]">
                        <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900 dark:text-gray-100">Laravel
                            Folio</span>
                        <span href="https://laravel.com/docs" class="inline-flex items-center font-normal leading-none text-gray-700 dark:text-gray-200">View
                            the Docs</span>
                    </span>
            ...
            <div>
                <a href="https://livewire.laravel.com/docs/volt" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-900/80 dark:hover:bg-gray-900 dark:border-gray-500/20 group gap-x-2.5 hover:bg-white">
                    <span class="flex items-center justify-center flex-none w-8 h-8">
                        <svg class="w-7 h-7" viewBox="0 0 27 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M26.5 24H15.9l4.6-24-20 26h11.8L2.5 56l24-32Z" fill="#FFD001" />
                        </svg>
                    </span>
                    <span class="flex flex-col justify-center h-full opacity-70 dark:opacity-80 group-hover:opacity-100 text-[0.65rem]">
                        <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900 dark:text-gray-100">Laravel
