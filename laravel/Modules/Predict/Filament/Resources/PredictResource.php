...
use Modules\Predict\Filament\Fields\ArticleContent;
use Modules\Predict\Filament\Fields\ArticleFooter;
use Modules\Predict\Filament\Fields\ArticleSidebar;
        ...
        return [
            Forms\Components\Grid::make()->columns(4)->schema([
                ...
                Forms\Components\TextInput::make('stocks_count')
                    ->label('Liquidità iniziale')
                    ->required()
                    ->numeric()
                    ->inputMode('decimal'),
                Forms\Components\TextInput::make('stocks_value')
                    ->label('Parametro di liquidità')
                    ->required()
                    ->numeric()
                    ->inputMode('decimal'),
